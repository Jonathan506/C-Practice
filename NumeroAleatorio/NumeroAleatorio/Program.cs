...
namespace NumeroAleatorio
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("**************---------------------*****************");
            Console.WriteLine("**************---------------------*****************");
            Console.WriteLine(" Introduzca el número que crees que salió ");
            int num = 101;
            int contador = 0;
            ...
            do
            {
                ...
                catch (OverflowException ex) //PRIMERO VAN LAS EXCEPCIONES DE TIPO ESPECIFICO Y LUEGO LAS GENERICAS
                {
                    Console.WriteLine("  Se ha introducido un valor númerico demasiado extenso, por favor introducir un valor de tipo numerico del  1 al 100 ");
                    // este excepción es para validar una excepcion en especial pero tiene que ir delante de un EXCEPCTION en caso de que haya uno
                }
                catch (Exception ex) //este objeto recibe como parametro un objeto de tipo excepcion  y la variable objeto que suele llamarse EX
                {
                    Console.WriteLine();
